...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Если token просрочен - создаём новый
     */
    ...
    public static function requestSignup(string $username, string $email, string $password): self
    {
        ...
        $user->created_at = time(); // Создается по-умолчанию
    ...
    /**
     * Устанавливаем статус на активный и удаляем ключ
     */
    ...
    /**
     * Преверка на совпадение статуса
     *
     * @return bool
     */
